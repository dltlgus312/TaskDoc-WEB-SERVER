...
function methodview(mcode){
	...
	var popW = 500; 
	var popH = 400; 
	window.open("/project/method/publicTask/view?tsdate="+tsdate+"&tedate="+tedate+"&pcode="+pcode,"", 'width='+ popW +',height='+ popH +',top='+ posT +',left='+ posL +',resizable=no,scrollbars=no'); 
}	
</script>
</html>