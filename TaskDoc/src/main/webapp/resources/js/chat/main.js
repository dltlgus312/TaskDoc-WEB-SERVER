				...
				if (response.length != -1) {
					...
					for(var i=0;i<response.chatRoomList.length;i++){
						...
						if(response.chatRoomList[i].crmode==1){
							...
							cArray.push(cObject);
							$cdiv='<div id="croom'+cArray[i].crcode+'" style="width:100%;height:105px; border: 1px solid #ed8151;" onclick="gochatCon('+cArray[i].crcode+',' + cArray[i].crmode +','+cArray[i].crclose+','+cArray[i].crcoderef+')">'
